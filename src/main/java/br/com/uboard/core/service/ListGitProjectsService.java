...
@Service
public class ListGitProjectsService {
    private static final Logger LOGGER = LoggerFactory.getLogger(ListGitProjectsService.class);
    private final GitClientFactory gitClientFactory;
    private final CustomObjectMapper customObjectMapper;
    private final CredentialRepository credentialRepository;
    private final VaultService vaultService;

    public ListGitProjectsService(GitClientFactory gitClientFactory,
    ...
    public List<GitProjectInterface> listGitProjects(String credentialIdentifier, SessionUserDTO sessionUserDTO, String pageSize)
    ...
    public List<GitProjectInterface> listGitProjects(String url, String token, ProviderEnum provider, String pageSize)
            throws UboardApplicationException {
        try {
            ...
            ResponseEntity<String> response = client.listProjects(defaultRequestHeaders, defaultRequestParams);
            ...
            TypeReference<? extends List<? extends GitProjectInterface>> typeReference = switch (provider) {
                case GITLAB -> new TypeReference<List<GitlabProjectDTO>>() {
                };
                default -> throw new IllegalArgumentException("There is no type to convert response body");
            };

            List<? extends GitProjectInterface> responseBody = this.customObjectMapper.fromJson(
